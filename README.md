...
> - *Yan Chang:* I developed several key UI components for the app, including the onboarding screens and the MBTI function and form within the profile setup flow. Through this work, I strengthened my skills in interface design, state management, and maintaining a cohesive design system using Vue.js. In addition to onboarding, I created the landing page and contributed to the home page, collaborating closely with Jordan to ensure a consistent and engaging user experience. I also helped Mikhail with the UI for the login and register pages, and supported Parikshit by refining the UI for the feedback page. These experiences gave me a deeper understanding of cross-team collaboration and the importance of aligning design choices across different parts of the app. Beyond development, I directed, filmed, and edited our marketing pitch video. This allowed me to expand my creative skill set and contribute to the project’s storytelling and overall presentation.
