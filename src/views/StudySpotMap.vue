<template>
  <div class="study-spot-map-container">
    <div class="search-controls pb-1 ps-0 bg-white border-b">
      ...
      <div class="d-flex justify-content-start align-items-center w-100">
        <input type="text" 
          ...
          style="width:80%; margin-left: 5px; margin-left: 0; border-radius: 5px;"
        />
        <Button
          outlined
          size="medium"
          ...
          style="width:20%; margin-left: 5px; border-radius: 10px;"
        >
        </Button>
      </div>
