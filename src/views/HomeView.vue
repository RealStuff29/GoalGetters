...
.primary-cta::before {
  ...
  background-image: 
    ...
    radial-gradient(1px 1px at 48% 5%, white, transparent),
    radial-gradient(1px 1px at 5% 20%, white, transparent),
    radial-gradient(2px 2px at 35% 45%, white, transparent),
    radial-gradient(1px 1px at 68% 88%, white, transparent),
    radial-gradient(1px 1px at 92% 25%, white, transparent),
    ...
    radial-gradient(1px 1px at 72% 22%, white, transparent),
    radial-gradient(2px 2px at 8% 82%, white, transparent),
    radial-gradient(1px 1px at 62% 58%, white, transparent),
    radial-gradient(1px 1px at 38% 8%, white, transparent),
    radial-gradient(2px 2px at 82% 48%, white, transparent),
    radial-gradient(1px 1px at 28% 52%, white, transparent),
    radial-gradient(1px 1px at 52% 92%, white, transparent),
    radial-gradient(2px 2px at 78% 68%, white, transparent),
    radial-gradient(1px 1px at 98% 15%, white, transparent),
    radial-gradient(1px 1px at 15% 88%, white, transparent),
    radial-gradient(2px 2px at 48% 35%, white, transparent),
    radial-gradient(1px 1px at 3% 55%, white, transparent),
    radial-gradient(1px 1px at 65% 5%, white, transparent),
    radial-gradient(2px 2px at 25% 98%, white, transparent),
    radial-gradient(1px 1px at 85% 42%, white, transparent),
    radial-gradient(1px 1px at 55% 72%, white, transparent),
    radial-gradient(2px 2px at 95% 78%, white, transparent),
    radial-gradient(1px 1px at 12% 28%, white, transparent),
    radial-gradient(1px 1px at 42% 18%, white, transparent),
    radial-gradient(2px 2px at 68% 98%, white, transparent),
    radial-gradient(1px 1px at 32% 42%, white, transparent) !important;
